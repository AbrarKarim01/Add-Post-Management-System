...
class PostController extends Controller
{
    ...
    public function isApproved(Request $request ,   $postId){
       $isapproved = $request->all();
       $post_id = $postId ;
    //    return $isapproved['isEnabled'];
       $post = Post::where('id' , $post_id)->first();
       $post->isapproved = $isapproved['isEnabled'] == '1' ? '1' : '0';
       $post->save();
       return response()->json( $post->isapproved );
    }
}
