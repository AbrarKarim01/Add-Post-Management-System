                    ...
                    <div class="container">
                        <div class="flex ">
                            ...
                            <div class="border-r-2 rounded p-2 text-bg-light mt-4 mx-2"
                                ...
                                <span class="text-2xl text-red-600">Super Admin Panel</span>
                                </a>
                                @elseif(Auth::user()->role  == '1')
                                <a href=#
                                class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                                <span class="text-2xl text-red-600">User Portal</span>
                                </a>
                                @else
                                <a href=#
                                class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                                <span class="text-2xl text-red-600">Admin Portal</span>
                                </a>
                                @endif
                                <hr>
